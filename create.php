...
// submitパラメータの値が存在する時（「登録」ボタンを押したとき）の処理
...
try {
	...
	// vendersテーブルからvendor_codeカラムのデータを取得するためのSQL文を変数$sql_selectに代入する
	...
	// SQL文の実行結果を配列で取得する
	// 補足；PDO::FETCH_COLUMNは１つのカラムの値を１次元配列（多次元ではない普通の配列）で取得する設定である
